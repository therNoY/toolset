...
public class JedisClusterTest {
    ...
    static {
        ...
        // 添加节点
        hostAndPortsSet.add(new HostAndPort("10.0.11.152", 7000));
        hostAndPortsSet.add(new HostAndPort("10.0.11.152", 7001));
        hostAndPortsSet.add(new HostAndPort("10.0.11.152", 7002));
        hostAndPortsSet.add(new HostAndPort("10.0.11.152", 7003));
        hostAndPortsSet.add(new HostAndPort("10.0.11.152", 7004));
        hostAndPortsSet.add(new HostAndPort("10.0.11.152", 7005));
...
//        // Jedis连接池配置
    ...
    private static JedisCluster getConn() {
        return jedis;
    }
