...
/**
 The base, abstract ClientNode model. Elements, Documents, Comments etc are all ClientNode instances.
...
public abstract class Node implements Cloneable {
    ...
    /**
     * Check if this ClientNode has an actual Attributes object.
     */
     ...
     * <p>
     * To getRespAndCookie an absolute URL from an attribute that may be a relative URL, prefix the key with <code><b>abs</b></code>,
     ...
     * <b>case insensitive</b>. The key will be set with case sensitivity as set in the xmlParser settings.
     * @param attributeKey The attribute key.
    ...
    /**
     * Set the baseUri for just this node (not its descendants), if this ClientNode tracks base URIs.
    ...
    /**
     Gets this node's parent node. Not overridable by extending classes, so useful if you really just need the ClientNode type.
     @return parent node; or null if no parent.
     */
    ...
    /**
     * Gets the Document associated with this ClientNode.
     * @return the Document associated with this ClientNode, or null if there is no such Document.
     */
    ...
    /**
     * Check if this node is the same instance of another (object identity zhi_hu_demo).
    ...
    public boolean equals(Object o) {
        // implemented just so that javadoc is clear this is an identity zhi_hu_demo
        return this == o;
    }
