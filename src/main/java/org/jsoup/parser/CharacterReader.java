...
public final class CharacterReader {
    ...
    void mark() {
        // extra buffer up, to getRespAndCookie as much rewind capacity as possible
        bufSplitPoint = 0;
        bufferUp();
        bufMark = bufPos;
    }
    ...
    String consumeTagName() {
        // '\t', '\n', '\r', '\f', ' ', '/', '>', nullChar
        // NOTE: out of spec, added '<' to fix base author bugs
        bufferUp();
        int pos = bufPos;
        final int start = pos;
        final int remaining = bufLength;
     ...
     * <p />
     * Simplistic, and on hash collisions just falls back to creating a new string, vs a full HashMap with MapEntry list.
