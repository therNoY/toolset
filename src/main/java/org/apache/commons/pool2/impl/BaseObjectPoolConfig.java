...
/**
 * Provides the implementation for the base attributes shared by the
...
public abstract class BaseObjectPoolConfig<T> extends BaseObject implements Cloneable {
    ...
    /**
     * The default value for the stand_alone name to use to name JMX enabled pools
     * created with a configuration instance. The default is <code>null</code>
     * which means the pool will provide the stand_alone name to use.
     * @see GenericObjectPool#getJmxName()
     * @see GenericKeyedObjectPool#getJmxName()
     */
    ...
    /**
     * Gets the value of the JMX name stand_alone that will be used as part of the
    ...
    /**
     * Sets the value of the JMX name stand_alone that will be used as part of the
     * name assigned to JMX enabled pools created with this configuration
     * instance. A value of <code>null</code> means that the pool will define
     * the JMX name stand_alone.
     *
