...
class LinkedBlockingDeque<E> extends AbstractQueue<E>
     ...
     * keep all Nodes GC-reachable from a predecessor dequeued ClientNode.
     * That would cause two problems:
     * - allow a rogue Iterator to cause unbounded memory retention
     * - cause cross-generational linking of old Nodes to new Nodes if
     *   a ClientNode was tenured while live, which generational GCs have a
     *   hard time dealing with, causing repeated major collections.
     * However, only non-deleted Nodes need to be reachable from
     * dequeued Nodes, and reachability does not necessarily have to
     * be of the kind understood by the GC.  We use the trick of
     * linking a ClientNode that has just been dequeued to itself.  Such a
    ...
    private static final class Node<E> {
        ...
        /**
         * One of:
         * - the real predecessor ClientNode
         * - this ClientNode, meaning the predecessor is tail
        ...
        /**
         * One of:
         * - the real successor ClientNode
         * - this ClientNode, meaning the successor is head
...
//     }
    ...
    private abstract class AbstractItr implements Iterator<E> {
        ...
        /**
         * ClientNode returned by most recent call to next. Needed by remove.
