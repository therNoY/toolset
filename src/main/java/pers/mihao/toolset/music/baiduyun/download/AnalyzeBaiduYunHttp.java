...
public class AnalyzeBaiduYunHttp {

	static Logger logger = LoggerFactory.getLogger(AnalyzeBaiduYunHttp.class);

	/**
	 * 向指定URL发送GET方法的请求 返回cookie，body等
	 * 会返回流里面的内容，如果下载大文件，需要修改，实时保存，避免内存溢出
	 */
	public static Map<String, String> getRespAndCookie(String url, String cookie) {
