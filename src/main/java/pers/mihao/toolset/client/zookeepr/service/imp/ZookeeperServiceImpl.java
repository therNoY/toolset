...
@Service
public class ZookeeperServiceImpl extends ServiceImpl<ZkSourceDao, ZkSource> implements ZookeeperService, BaseSourceService {
    ...
    public ClientNode sourceToNode(DataSource source){
