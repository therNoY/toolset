...
/**
 * A simple stand_alone implementation of {@link ObjectPool}.
...
public abstract class BaseObjectPool<T> extends BaseObject implements ObjectPool<T> {
    ...
    /**
     * Not supported in this stand_alone implementation.
     *
    ...
    /**
     * Not supported in this stand_alone implementation. Subclasses should override
     * this behavior.
     *
     * @throws UnsupportedOperationException if the pool does not implement this
     *          method
