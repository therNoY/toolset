...
/**
 * Base class that provides base functionality for {@link GenericObjectPool}
...
public abstract class BaseGenericObjectPool<T> extends BaseObject {
     ...
     * @param jmxNameBase   The default stand_alone JMX name for the new pool unless
     ...
     *
     * @param config Pool configuration
     * @param jmxNameBase default stand_alone JMX name for this pool
