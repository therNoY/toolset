 ...
 * <p>
 * To getRespAndCookie a new Connection, use {@link Jsoup#connect(String)}. Connections contain {@link Request}
...
public interface Connection {
    ...
    /**
     * Provide an alternate xmlParser to use when parsing the response to a Document. If not set, defaults to the HTML
     * xmlParser, unless the response content-type is XML, in which case the XML xmlParser is used.
     * @param xmlParser alternate xmlParser
     * @return this Connection, for chaining
     */
    Connection parser(XmlParser xmlParser);
    ...
    /**
     * 原来是执行一个封装好的请求 直接将结果解析成document
     ...
     * 传递参数
     */
    HttpResponse post(Map<String, String> map) throws IOException;
     ...
     * @throws IOException
     */
    String getForLocation() throws IOException;
    ...
    interface Request extends Base<Request> {
        ...
        /**
         * Specify the xmlParser to use when parsing the document.
         * @param parser xmlParser to use.
         * @return this Request, for chaining
         */
        ...
        /**
         * Get the current xmlParser to use when parsing the document.
         * @return current XmlParser
         */
        Parser parser();
    ...
    interface Response extends Base<Response> {
         ...
         * @throws IOException on error
         */
        Document parseXml() throws IOException;
         ...
         * @throws IOException on error
         */
        JSONObject parseJson() throws IOException;
