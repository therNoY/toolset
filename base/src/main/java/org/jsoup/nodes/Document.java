...
public class Document extends Element {
    ...
    private XmlParser xmlParser; // the xmlParser used to parse this document
    ...
    // fast method to getRespAndCookie first by tag name, used for html, head, body finders
    ...
    /**
     * Get the xmlParser that was used to parse this document.
    ...
    /**
     * Set the xmlParser used to create this document. This xmlParser is then used when further parsing within this document
     * is required.
     * @param xmlParser the configured xmlParser to use when further parsing is required for this document.
     * @return this document, for chaining.
     */
    public Document parser(XmlParser xmlParser) {
