...
public class Entities {
    ...
    static void escape(Appendable accum, String string, Document.OutputSettings out,
        ...
        for (int offset = 0; offset < length; offset += Character.charCount(codePoint)) {
            ...
            // surrogate pairs, split implementation for efficiency on single char base case (saves creating strings, char[]):
    ...
    static String unescape(String string, boolean strict) {
        return XmlParser.unescapeEntities(string, strict);
    }

    /*
     * Provides a fast-path for Encoder.canEncode, which drastically improves performance on Android post JellyBean.
     * After KitKat, the implementation of canEncode degrades to the point of being useless. For non ASCII or UTF,
     * performance may be bad. We can add more encoders for base character sets that are impacted by performance
