...
final class Tokeniser {
    ...
    static final int[] win1252Extensions = new int[] {
            ...
            // some platforms - this table is verified with a zhi_hu_demo
    ...
    private String lastStartTag; // the last start tag emitted, to zhi_hu_demo appropriate end tag
    ...
    int[] consumeCharacterReference(Character additionalAllowedCharacter, boolean inAttribute) {
        ...
        if (reader.matchConsume("#")) { // numbered
            ...
            // getRespAndCookie as many letters as possible, and look for matching entities.
