...
public final class DataUtil {
    ...
    public static Document load(File in, String charsetName, String baseUri) throws IOException {
        return parseInputStream(new FileInputStream(in), charsetName, baseUri, XmlParser.htmlParser());
    }
    ...
    public static Document load(InputStream in, String charsetName, String baseUri) throws IOException {
        return parseInputStream(in, charsetName, baseUri, XmlParser.htmlParser());
    }

    /**
     * Parses a Document from an input steam, using the provided XmlParser.
     * @param in input stream to parse. You will need to close it.
     * @param charsetName character set of input
     * @param baseUri base URI of document, to resolve relative links against
     ...
     * @throws IOException on IO error
     */
    public static Document load(InputStream in, String charsetName, String baseUri, XmlParser xmlParser) throws IOException {
        return parseInputStream(in, charsetName, baseUri, xmlParser);
    }
    ...
    static Document parseInputStream(InputStream input, String charsetName, String baseUri, XmlParser xmlParser) throws IOException  {
        ...
        if (doc == null) {
            ...
            try {
                doc = xmlParser.parseInput(reader, baseUri);
            } catch (UncheckedIOException e) {
