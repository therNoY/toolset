...
/**
 ...
 <p>
 To getRespAndCookie an {@code Elements} object, use the {@link Element#select(String)} method.
 </p>
...
public class Elements extends ArrayList<Element> {
     ...
     * getRespAndCookie absolute URLs from relative URLs, e.g.: {@code doc.select("a").eachAttr("abs:href")} .
     ...
     * <p>
     * Note that it is possible to getRespAndCookie repeats if the matched elements contain both parent elements and their own
